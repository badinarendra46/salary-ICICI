...
--
-- Administration User for the schema `salary`
--

DROP USER IF EXISTS 'salary'@'localhost';
CREATE USER 'salary'@'localhost' IDENTIFIED BY 'salary' PASSWORD EXPIRE NEVER;
GRANT ALL ON `salary`.* TO 'salary'@'localhost';
GRANT SELECT, INSERT ON `salary`.* TO 'salary'@'localhost';
